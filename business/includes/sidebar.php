        ...
        <div class="sidebar-brand-icon"><img class=" img-profile" src="../uploads/logoT.png" width="50" height="50"></div>
            <div class="sidebar-brand-text mx-3"><span>I - Eat</span></div>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link <?= $page == "reservation.php"? 'active':'';  ?>" href="reservation.php?id=<?= $_SESSION['auth_user']['businessid'];?>"><i class="fa fa-clipboard-list"></i><span>&nbspReservation</span></a></li>
                    <li class="nav-item"><a class="nav-link <?= $page == "table.php"? 'active':'';  ?>" href="table.php?id=<?= $_SESSION['auth_user']['businessid'];?>"><i class="fas fa-edit"></i><span>&nbspTable Management</span></a></li>
                    <li class="nav-item"><a class="nav-link <?= $page == "menu.php"? 'active':'';  ?>" href="menu.php?id=<?= $_SESSION['auth_user']['businessid'];?>"><i class="fas fa-utensils"></i><span>&nbspMenu Management</span></a></li>
                    <li class="nav-item"><a class="nav-link <?= $page == "feedback.php"? 'active':'';  ?>" href="feedback.php?id=<?= $_SESSION['auth_user']['businessid'];?>"><i class="far fa-file-alt"></i><span>&nbspFeedback</span></a></li>
