...
?>
 <?php 
        if(isset($_GET['id']))
        {
            ...
            //query string
            $table_query = "SELECT * FROM blockdate WHERE NOT status = 2  AND businessid = $id LIMIT $offset, $total_records_per_page";
            // result
                                        ...
                                        foreach($result as $item)
                                        {
                                            if($item['businessid'] == $_SESSION['auth_user']['businessid'])
                                                ...
                                                ?>
                                                        ...
                                                        ?></td>                                                                                                         
                                                        <td>
                                                            <a href="edit-reservation.php?id=<?= $item['blockdateid']; ?>" class="btn edit-btn"><i class="fas fa-pencil-alt"></i></a>
                                                        </td>
                                                        <!-- <td>
