                                ...
                                <div class="product" >
                                    <div class="row justify-content-center pb">
                                        ...
                                        <div class="col p-0"><hr class="mb-0">
                                            ...
                                            <p class="float-end m-2 text-muted">Status:&nbsp;<strong><?php if($data['status'] == 0){ echo 'Waiting'; } elseif($data['status'] == 1){ echo 'Approved';}elseif($data['status'] == 2){echo 'Declined';}elseif($data['status'] == 3){echo 'Cancelled';}elseif($data['status'] == 1 && $data['arrived'] == 1){ echo 'For Review';}  ?></strong></p>
                                        </div><hr class="mt-0">
                                    </div>
                                </div>
