                    ...
                    <div class="card mb-5 ">
                        <div class="card-body flex-column">
                            ...
                            <div class="btn-group btn-group-sm border rounded flex-grow-1" role="group" >
                                <button class="btn btn-primary active" type="submit" onclick="location.href='ownerlogin.php'" title="For business owner.">Business User</button>
                                <button class="btn btn-primary unactive" type="submit" onclick="location.href='login.php'"title="For customer.">Customer</button>
                            </div>
