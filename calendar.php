...
function build_calendar($month,$year,$resourceid){
    ...
    if($stmt -> execute())
    {
        ...
        if($result -> num_rows > 0)
        {
            $calendar.="<label class='float-start pt-1'>Choose table you'll accomodate :<span style='color:red;'>*</span>&nbsp; &nbsp;</label><select id='resource_select' class='form-select-sm border-1 mb-3 w-100' required>";
