    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark" style="height: auto;background: transparent;">
            <img class="img-fluid d-flex d-lg-flex align-items-center m-auto" loading="eager" src="uploads/I-EatLogo.png" width="200px" height="200px" alt="logo" usemap="#workmap">
                ...
                <form method="post" action="functions/authcode.php" enctype="multipart/form-data" style="background: rgb(255, 128, 64);border-style: solid;border-color: rgb(255, 128, 64);border-top-color: rgb(255,;border-right-color: 128,;border-bottom-color: 64);border-left-color: 128,;border-radius: 20px;">
                    <div class="container">
