...
?>
 <?php 
            ...
            $result_count = mysqli_query($con, "SELECT COUNT(*) as total_records FROM mealcategory WHERE status = 2") or die(mysqli_error($con));
            //total records
            ...
            //query string
            $table_query = "SELECT * FROM mealcategory WHERE status = 2 ORDER BY categoryid DESC LIMIT $offset, $total_records_per_page";
            // result
            $result = mysqli_query($con,$table_query) or die(mysqli_error($con));
?>
    <div class="container-fluid pt-3">
            <h4 class="text-dark">Category Archive</h4>
                        ...
                        <tbody style="text-align:center">
                            <?php
                               ...
                               if(mysqli_num_rows($result) > 0)
                               {
                                   ...
                                   {
                                    // if($item['useridid'] == $_SESSION['auth_user']['userid'])
                                    //     {
                                       ?>
                                       <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success btn-sm" type="submit" value = "<?= $item['categoryid']; ?>" name="restore_category_btn"><i class="fas fa-archive"></i> </button>
                                            </td>
                                       </tr>
                                       <?php
                                        // }
