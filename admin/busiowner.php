                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/dogs/image2.jpeg" width="160" height="160">
                                    <div class="mb-3"><button class="btn btn-primary btn-sm" type="button" style="background: rgb(255,128,64);border-style: none;">Change Photo</button></div>
                                </div>
                            </div>
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" style="background: rgb(255,128,64);border-style: none;">Save Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
