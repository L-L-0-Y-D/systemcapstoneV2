...
<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(255,128,64);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link <?= $page == "location.php"? 'active':'';  ?>" href="location.php?id=<?= $_SESSION['auth_user']['businessid'];?>"><i class='fas-solid fas-location-pin'></i></i><span>Location</span></a></li>
                </ul>
