...
?>
 <?php 
    ...
    $result_count = mysqli_query($con, "SELECT COUNT(*) as total_records FROM users WHERE archive='1'") or die(mysqli_error($con));
    //total records
    ...
    //query string
    $table_query = "SELECT * FROM users WHERE archive='1' ORDER BY userid DESC LIMIT $offset, $total_records_per_page";
    // result
