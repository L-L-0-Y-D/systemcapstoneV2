                                ...
                                <div class="row g-0" style="width: 729px;">
                                    ...
                                    <a href="#">
                                        <div class="clean-product-item" style="padding: 10px;">
                                            ...
                                            <div class="product-name" style="margin-bottom: 0px;"><a href="#"><strong><?= $item['business_name']; ?></strong></a></div><small>Located at <?= $item['business_name']; ?> <?= $data['municipality_name']; ?>, Bataan</small>
                                            <div class="about">
