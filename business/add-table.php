    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4>Add Table
          <a href="table.php?id=<?= $_SESSION['auth_user']['businessid'];?>" class="btn btn-primary float-end" style="background:rgb(255,128,64); border:none;">Back</a></h4>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
						...
						<select  name="chair" required class="form-control mb-2">
							<option disabled selected hidden> Select the number of chairs</option>
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-primary" name="add_table_btn" >Save</button>
                    </div>
                </div>
            </form>
        </div>
