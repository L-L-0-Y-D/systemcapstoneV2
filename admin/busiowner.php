...
<?php
    ...
    $result_count = mysqli_query($con, "SELECT COUNT(*) as total_records FROM business WHERE NOT status = '3'") or die(mysqli_error($con));
    //total records
