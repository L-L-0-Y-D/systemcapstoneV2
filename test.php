...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive" style="padding-left:10px;background-color:rgb(255,128,64);" >
                ...
                elseif(isset($_SESSION['auth']))
                {
                        ...
                        ?>
                        <li class="nav-item">
                            <h2 class="text-white text-capitalize fw-normal" style="margin-top:5px;font-size:25px;"> Welcome 
                            <strong><?= $_SESSION['auth_user']['name'];?></strong>!&nbsp;</h2>
                        </li>
                        <li class="nav-item">
                            <div class="dropdown no-arrow">
                                <a class="dropdown-toggle text-black fs-4" aria-expanded="false" data-bs-toggle="dropdown">
                        ...
                        else if($_SESSION['auth_user']['role_as'] == "2")
                        {
                            ?>
                            <li class="nav-item">
                                <h2 class="text-white text-capitalize" style="margin-top:5px;font-size:25px;"> Welcome
    ...
    <nav class="navbar navbar-dark navbar-expand-lg sticky-top " id="mainNav-1" style="margin-top:100px;background:transparent;">
        <div class="container">
            <button data-bs-toggle="collapse" data-bs-target="#navbarResponsive" class="navbar-toggler float-end navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse float-start" id="navbarResponsive-1" style="font-size: 14px;font-weight: bold;">
                <ul class="navbar-nav d-lg-flex mx-auto align-items-lg-center text-uppercase ">
                    <li class="nav-item"><a class="nav-link" style="color:rgb(255,128,64);" href="#services">ABOUT</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:rgb(255,128,64);" href="#portfolio">MENU</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:rgb(255,128,64);" href="#about">REVIEWS</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:rgb(255,128,64);" href="#team">LOCATION</a></li>
                    <li class="nav-item"><button class="btn btn-primary" type="button" style="padding-top: 6px;padding-bottom: 6px;background: var(--bs-white);color: rgb(255,128,64);">MAKE RESERVATION</button></li>
                </ul>
            </div>
        </div>
    </nav>
